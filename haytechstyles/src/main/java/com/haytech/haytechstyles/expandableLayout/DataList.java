...
public class DataList {
    ...
    public static List<DataList> getListData() {
        ...
        lists.add(new DataList(" یوسفی", "1398 / 11201/05 / 1008 / 244", false));
        lists.add(new DataList(" جانباز", "1398 / 11201/05 / 1008 / 244", false));
        lists.add(new DataList(" حسنی", "1398 / 11201/05 / 1008 / 244", false));
        lists.add(new DataList(" مرادی", "1398 / 11201/05 / 1008 / 244", false));
        lists.add(new DataList(" یوسفی", "1398 / 11201/05 / 1008 / 244", false));
        return lists;
    }
}
